...
const Vendas = () => {
  ...
  useEffect(() => {
    // Filtra as vendas com base na busca
  ...
  const handleCancelarVenda = async () => {
    ...
    try {
      await axios.put(`/api/vendas/${vendaToCancel.id}/cancelar`, { motivo });
              ...
              displayedVendas.map((venda) => (
                <TableRow key={venda.id}>
                  ...
                  <TableCell align="center">
                    ...
                    {hasPermission(['admin', 'vendedor']) && venda.status !== 'cancelada' && (
                      <IconButton
                        color="error"
